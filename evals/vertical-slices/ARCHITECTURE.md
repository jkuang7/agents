Likely responsibilities include inventory, run state, persistence, job
...
they occur in one orchestration workflow. Another blocks audit and readiness
work until a real disposable repository is authorized, even though local
fixtures can verify that behavior.
